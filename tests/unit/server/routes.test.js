...
describe('#Routes - test site for api response',()=>{
  ...
  test(`GET /home - should response with ${pages.homeHTML} home/index.html file stream`, async ()=>{
    const params = TestUtil.defaultHandleParams()
    params.request.method = 'GET'
  ...
  test(`GET /controller - should response with ${pages.controllerHTML} controller/index.html file stream`, async ()=>{
    const params = TestUtil.defaultHandleParams()
    params.request.method = 'GET'
